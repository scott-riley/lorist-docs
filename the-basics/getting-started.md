...
Lorist is a pretty straightforward app when in comes down to it, but there are a few things you might want to know to get the best out of your time writing lovely words.

## Local-only saving

Lorist is a web app, but all of your writing is saved locally to your browser. Nothing is synced to a third-party service, or any remote server at all. This is an intentional feature, but it also might not be what you’re used to in a web app.

It also means that if you switch browsers or devices, you’re essentially getting a brand new instance of Lorist. There’ll be a Desktop app coming soon for folks who want to keep Lorist fully file-based, and we’ll make it as easy as possible to transition when it launches.

If local-only isn’t your thing and you _really need_ remote syncing, that’s all good, Lorist just isn’t the app for you!
...
**OpenDyslexic** uses <a href="https://abbiegonzalez.com/">Abbie Gonzalez’s</a> OpenDyslexic font, which some folks with neurodevelopmental disorders and cognitive impairments claim to find easier to read and write with. Similar to monospace fonts, there’s no scientific consensus on this, but typography isn’t a science, and if OpenDyslexic works for you, it works for you.

Both the light and dark themes and the editor’s typographic themes have been designed individually to give the best possible writing and proofreading experience for each. You might find some combination of options better for long writing sessions, and others better for proofreading. Spend some time with any of them and see what you prefer.
